...
# This script is used to install Python
# Version 1.0
...
cd ~/pyinstall
wget https://pypi.python.org/packages/source/d/distribute/distribute-0.6.27.tar.gz --no-check-certificate
tar -xzf distribute-0.6.27.tar.gz
cd distribute-0.6.27
python2.7 setup.py install

# Delete temp install directory
cd ~
rm pyinstall -rf